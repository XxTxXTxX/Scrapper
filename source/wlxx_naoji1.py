...
class Spider(object):
    ...
    def __init__(self,args):
        ...
        self.args.source_name = '脑机接口产业联盟'
        self.args.fuzeren = '' 
    ...
    def html2res(self, url, date='', i=1):
        ...
        title = soup1.find('h1', {'class': 'rich_media_title'}).get_text()
    ...
    def run(self):
        ...
        with open("./utils/naojijiekouchanyelianmeng.yaml", "r", encoding="gbk") as file:
            file_data = file.read()
